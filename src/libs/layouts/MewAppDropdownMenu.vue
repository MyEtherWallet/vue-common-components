<template>
  <Menu as="div" class="relative inline-block text-left" @mouseover="open = true" @mouseleave="open = false">
    <div>
    ...
    <transition enter-active-class="transition duration-100 ease-out" enter-from-class="transform scale-95 opacity-0"
      ...
      <div v-show="open">
        <MenuItems :id="`menu-items-${text}`" static class="absolute -left-4 origin-top-right focus:outline-none">
          <div
