<template>
  <footer class="max-w-[1392px] px-5 md-header:px-10 mx-auto pt-[104px] mb-5">
    <div class="grid grid-cols-1 gap-[42px]">
      <div
        class="grid grid-cols-1 md:grid-cols-4 justify-items-start content-start gap-[42px]"
      >
        <div class="grid grid-cols-1 gap-2.5 content-start">
          ...
          />
          <MewLink
            :link-url="PROJECT_LINKS[PROJECTS.PORTFOLIO].HOW_IT_WORKS"
            :class="linkClass"
            :curr-project="props.currProject"
            :link-component="props.linkComponent"
          ...
          <MewLink
            ...
            :curr-project="props.currProject"
            :link-component="props.linkComponent"
            :link-text="t('security_policy')"
            @mewlink:click="trackSecurityPolicy"
          />
          <a
            href="https://hackenproof.com/programs/myetherwallet"
            target="_blank"
            :class="linkClass"
        ...
        <div class="grid grid-cols-1 gap-2.5 content-start">
          ...
          <a
            ...
            target="_blank"
            :class="['flex items-center pa-2', linkClass]"
      ...
      <div
        class="grid grid-cols-1 md:grid-cols-2 justify-items-start content-start gap-[42px]"
      >
