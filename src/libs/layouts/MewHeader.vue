      ...
      'max-w-[1392px] h-full md-header:mx-6 2xl:mx-auto md-header:rounded-[52px] transition-all duration-500',
      {
        ...
        <div class="flex flex-row items-center justify-between px-4 my-auto h-full">
          ...
          <div class="hidden md-header:flex flex-row gap-x-5 xl:gap-x-8">
            ...
            <a href="https://www.myetherwallet.com/how-it-works#swap"
              class="font-medium text-base xl:text-lg hoverOpacity" @click="trackSwap">Swap Tokens</a>
            <!-- More Features Dropdown -->
            <AppDropdownMenu text="More Features">
              <template #items>
                <div class="grid gap-6">
                  <MenuItem id="header-more-feat-staking" class="hoverOpacity">
                  <link-component to="/staking" class="text-base xl:text-lg"
                    @click="trackStaking">Staking</link-component>
                  </MenuItem>
                  <MenuItem id="header-more-feat-nft" class="hoverOpacity">
                  <a href="https://www.myetherwallet.com/how-it-works#nft" class="text-base xl:text-lg"
                    @click="trackNft">NFT</a>
                  </MenuItem>
                  <MenuItem id="header-more-feat-dapps" class="hoverOpacity">
                  <a href="https://www.myetherwallet.com/how-it-works#dapps" class="text-base xl:text-lg"
                    @click="trackDapps">DApps</a></MenuItem>
                </div>
              </template>
            </AppDropdownMenu>
            <!-- Resources Dropdown -->
            <AppDropdownMenu text="Resources">
              <template #items>
                <div class="grid gap-6">
                  ...
                  <a href="https://www.myetherwallet.com/blog" target="_blank" class="text-base xl:text-lg"
                    @click="trackMewtopia">Blog</a>
                  </MenuItem>
                  <MenuItem id="header-resources-help-center" class="hoverOpacity">
                  <a href="https://help.myetherwallet.com/en/" target="_blank" class="text-base xl:text-lg"
                    @click="trackHelpCenter">Help Center</a>
                  </MenuItem>
                  <MenuItem id="header-resources-faq" class="hoverOpacity">
                  <link-component to="/faq" @click="trackFAQ">FAQ</link-component>
                  </MenuItem>
                  <MenuItem id="header-resources-customer-support" class="hoverOpacity">
                  <a href="mailto:support@myetherwallet.com" rel="noopener noreferrer" target="_blank"
                    class="text-base xl:text-lg" @click="trackCustomerSupport">Customer Support</a>
                  </MenuItem>
                </div>
              </template>
            </AppDropdownMenu>
            ...
            <AppDropdownMenu text="Products">
              <template #items>
                <div class="grid grid-cols-1 3xl:grid-cols-2 gap-2 min-w-[330px] 3xl:min-w-[568px]">
                  <MenuItem id="header-products-mew-wallet" class="hoverBGGrey rounded-2xl p-2">
                  ...
                  <MenuItem id="header-products-mew" class="hoverBGGrey rounded-2xl p-2">
                  <a href="https://www.myetherwallet.com/wallet/access" target="_blank" class="flex items-center pa-2"
                  ...
                  <MenuItem id="header-products-enkrypt" class="hoverBGGrey rounded-2xl p-2">
                  ...
                  <MenuItem id="header-products-ethVM" class="hoverBGGrey rounded-2xl p-2">
          ...
          <!-- Access Button -->
          <a href="https://www.myetherwallet.com/wallet/access" target="_blank"
