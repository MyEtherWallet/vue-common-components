  ...
  <Transition name="expand-app-mobile-menu">
    <div v-if="isOpen" class="bg-white h-screen w-screen z-40 fixed overflow-y-auto" role="dialog">
      ...
      <div class="grid grid-cols-1 gap-6 px-6">
        <link-component to="/" class="text-lg font-medium leading-6 hoverOpacity p-2"
          @click="trackHome">Home</link-component>
        ...
        <a href="https://www.myetherwallet.com/how-it-works#swap" class="text-lg font-medium leading-6 hoverOpacity p-2"
          @click="trackSwap">Swap Tokens</a>
        ...
        <div class="text-lg font-medium leading-6" @click="featuresToggle">
          ...
          <div v-show="isFeaturesOpen"
            ...
            <link-component to="/staking" class="hoverOpacity cursor-pointer p-2"
              @click="trackStaking">Staking</link-component>
            <a href="https://www.myetherwallet.com/how-it-works#nft" class="hoverOpacity cursor-pointer p-2"
              @click="trackNft">NFT</a>
            <a href="https://www.myetherwallet.com/how-it-works#dapps" class="hoverOpacity cursor-pointer p-2"
              @click="trackDapps">DApps</a>
          </div>
        </div>
        <!-- Resources Dropdown -->
        <div class="text-lg font-medium leading-6" @click="resourcesToggle">
          ...
          <div v-show="isResourcesOpen" class="grid grid-cols-1 gap-4 px-3 pt-8 pb-2">
            ...
            <link-component to="/faq" class="hoverOpacity cursor-pointer p-2" @click="trackFAQ">FAQ</link-component>
        ...
        <div class="flex">
          <a href="https://www.myetherwallet.com/wallet/access" target="_blank"
            class="px-4 py-2 bg-black text-white h-10 rounded-3xl hoverOpacity" @click="trackAccessWallet">
            <div class="text-base xl:text-lg font-medium leading-6 tracking-sp-06">
              Access my wallet
            </div>
          </a>
        </div>
